        ...
        return (
            <div>
                <Navbar style={{marginBottom:50}}>
                    ...
                    <Nav>
                        <NavItem eventKey={1} href="#">用户信息设置页</NavItem>
                ...
                <Panel header={'用户信息'} bsStyle="primary">
                    <div className="row">
                        ...
                        <Col md={4} className="text-left">
                            <p>投稿数：20&nbsp;&nbsp;&nbsp;&nbsp;共被浏览：1000次</p>
                            <p>经验值：1234/2000</p>
                            <p>特长：平面设计、影视后期</p>
                        </Col>
                        <Col md={4} className="text-right">
                            <p><Button bsStyle="primary">修改信息</Button></p>
                ...
                <Tabs defaultActiveKey={1}>
                    ...
                    <Tab eventKey={2} title="我的收藏">
                        <ArtworkQueryForm />
                        <ArtworkList className={style.artworkList} title="收藏作品" hasDelBtn="true"/>
                        <Pagination
                            prev
                            next
                            first
